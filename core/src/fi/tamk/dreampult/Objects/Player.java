...
public class Player {
    ...
    public Player(World world, GameLoop game) {
        ...
        Texture imgBody = game.assets.get("./images/body.png", Texture.class);
        Texture imgLeg = game.assets.get("./images/leg.png", Texture.class);
        Texture imgLeftArm = game.assets.get("./images/left_arm.png", Texture.class);
        Texture imgRightArm = game.assets.get("./images/right_arm.png", Texture.class);
        Texture imgHead = game.assets.get("./images/headwithball.png", Texture.class);
